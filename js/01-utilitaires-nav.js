...
function renderSidebar(){
  ...
  if(student.prenom && screen!=='login'){
    ...
    if(!isTeacher){ html += `<button class="nav-btn ${screen==='historique'?'active':''}" style="--tag-color:#8338ec" onclick="goHistorique()"><span class="tag">📚</span> Historique de mes cours</button>`; }
  }
